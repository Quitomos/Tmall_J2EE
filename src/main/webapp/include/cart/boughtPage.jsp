...
<div class="boughtDiv">
    <div class="orderType">
        ...
        <div><a orderStatus="待付款" href="#nowhere">待付款</a></div>
        <div><a orderStatus="待发货" href="#nowhere">待发货</a></div>
        <div><a orderStatus="待收货" href="#nowhere">待收货</a></div>
        <div><a orderStatus="待评价" href="#nowhere" class="noRightborder">待评价</a></div>
