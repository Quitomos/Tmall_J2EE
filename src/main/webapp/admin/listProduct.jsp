        ...
        <div class="panel-body">
            <form method="post" id="addForm" action="admin_product_add">
                <table class="addTable">
                    ...
                    <tr>
                        <td>原价格</td>
                        <td><input id="originalPrice" value="100" name="originalPrice" type="text"
                                   class="form-control"></td>
                    </tr>
                    <tr>
                        <td>优惠价格</td>
                        <td><input id="promotePrice" value="1" name="promotePrice" type="text"
                                   class="form-control"></td>
                    </tr>
                    <tr>
                        <td>库存</td>
                        <td><input id="stock" value="3" name="stock" type="text"
                                   class="form-control"></td>
                    </tr>
                    <tr class="submitTR">
